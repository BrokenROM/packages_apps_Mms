...
public class ConversationOptionsActivity extends Activity {
    ...
    public class ConversationOptionsFragment extends PreferenceFragment
        ...
        private BrokenConversationSettings mConversationSetting;

        @Override
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);

            new AsyncTask<Long, Void, BrokenConversationSettings>() {
                @Override
                protected BrokenConversationSettings doInBackground(Long... params) {
                    if (DEBUG)
                        Log.d(TAG, "Getting conversation setting of " + params[0]);
                    return BrokenConversationSettings.getOrNew(getActivity(), params[0].longValue());
                }

                @Override
                protected void onPostExecute(BrokenConversationSettings conversationSettings) {
                    if (DEBUG) {
