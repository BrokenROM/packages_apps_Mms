...
public class BrokenMmsDatabaseHelper extends SQLiteOpenHelper {
    ...
    public static final String DATABASE_CREATE = "CREATE TABLE " + CONVERSATIONS_TABLE + "("
            ...
            + ");";
    private static final String TAG = "BrokenMmsDatabaseHelper";
    private static final String DATABASE_NAME = "broken_mms.db";
    private static final int DATABASE_VERSION = 1;
    private static BrokenMmsDatabaseHelper mInstance;

    private BrokenMmsDatabaseHelper(Context context) {
        super(context, DATABASE_NAME, null, DATABASE_VERSION);
    }

    public static BrokenMmsDatabaseHelper getInstance(Context context) {
        if (mInstance == null) {
            mInstance = new BrokenMmsDatabaseHelper(context.getApplicationContext());
        }
        return mInstance;
    }
    ...
    public void insertBrokenConversationSettings(BrokenConversationSettings conversationSettings) {
    ...
    // boolean version
    public void updateBrokenConversationSettingsField(long threadId, String field, int value) {
        SQLiteDatabase db = getWritableDatabase();
        ContentValues contentValues = new ContentValues();
    ...
    // string version
    public void updateBrokenConversationSettingsField(long threadId, String field, String value) {
        SQLiteDatabase db = getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(field, value);
        db.update(CONVERSATIONS_TABLE, contentValues,
    ...
    public void updateBrokenConversationSettings(BrokenConversationSettings conversationSettings) {
        SQLiteDatabase db = getWritableDatabase();
        ContentValues contentValues = new ContentValues();
        contentValues.put(CONVERSATIONS_NOTIFICATION_ENABLED, conversationSettings.mNotificationEnabled);
        contentValues.put(CONVERSATIONS_NOTIFICATION_TONE, conversationSettings.mNotificationTone);
    ...
    public void deleteBrokenConversationSettings(long threadId) {
        SQLiteDatabase db = getWritableDatabase();
    ...
    public void deleteAllBrokenConversationSettings() {
        SQLiteDatabase db = getWritableDatabase();
